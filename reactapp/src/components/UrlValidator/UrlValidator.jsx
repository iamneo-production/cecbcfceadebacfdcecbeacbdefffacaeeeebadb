...
//         <label htmlFor="domain">Domain:</label>
//         <input type="text" id="domain" data-testid="domain" />
//         <br />
//         <label htmlFor="path">Path:</label>
//         <input type="text" id="path" data-testid="path" />
//         <br />
//         <label htmlFor="method">Method:</label>
//         <input type="text" id="method" data-testid="method" />
//         <br />
//         <label htmlFor="body">Body:</label>
//         <input type="text" id="body" data-testid="body" />
//         <br />
